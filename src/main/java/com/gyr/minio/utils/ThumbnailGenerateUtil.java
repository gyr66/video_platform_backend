...
@Component
public class ThumbnailGenerateUtil {
    ...
    public File getThumbnail(String id, String fileName) throws IOException {
        // 工作目录
        ...
        // 目标文件
        File target = new File(targetDir.getAbsolutePath() + "//" + id + ".jpg");
        ...
        try {
            ...
            logger.info(result == 0 ? "生成缩略图成功" : "生成缩略图失败");
        } catch (Exception e) {
            e.printStackTrace();
        }
        return target;
